...
# Open Dataset
    ...
    if os.path.exists(f"{store}/pathway4_pr02_PGW_{y}_{m:02d}.p"):
        print("jump")
        continue
    ...
    pickle.dump( aux1, open( f"{store}/pathway1_pr02_PGW_{y}_{m:02d}.p", "wb" ) )
    pickle.dump( aux2, open( f"{store}/pathway2_pr02_PGW_{y}_{m:02d}.p", "wb" ) )
    pickle.dump( aux3, open( f"{store}/pathway3_pr02_PGW_{y}_{m:02d}.p", "wb" ) )
    pickle.dump( aux4, open( f"{store}/pathway4_pr02_PGW_{y}_{m:02d}.p", "wb" ) )
