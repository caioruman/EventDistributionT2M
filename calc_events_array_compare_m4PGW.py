...
def main(args):
  ...
  for y in range(datai, dataf+1):
    ...
    for m in range(1, 13):
      ...
      if os.path.exists(f"{store}/t2m_m4PGW_m12CTRL_{y}_{m:02d}.p"):
        print("jump")
        continue      
      ...
      m4PGW_m4CTRL = np.zeros(ctrl_minus4.shape)
      ...
      m4PGW_m8CTRL = np.zeros(ctrl_minus4.shape)
      ...
      m4PGW_m12CTRL = np.zeros(ctrl_minus4.shape)
